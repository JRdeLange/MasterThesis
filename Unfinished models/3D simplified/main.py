...
if __name__ == '__main__':
    ...
    dqn.load_weights('shortchasetimewithhalt14act9pass380000020000.h5f')
    ...
    dqn.save_weights('shortchasetimewithhalt14act9pass240000020000.h5f', overwrite=True)

    dqn.fit(environment, nb_steps=400000, visualize=False, verbose=2, nb_max_episode_steps=10000,
            forward_other_agents=True)

    dqn.save_weights('shortchasetimewithhalt14act9pass280000020000.h5f', overwrite=True)

    dqn.fit(environment, nb_steps=400000, visualize=False, verbose=2, nb_max_episode_steps=10000,
            forward_other_agents=True)

    dqn.save_weights('shortchasetimewithhalt14act9pass320000020000.h5f', overwrite=True)

    dqn.fit(environment, nb_steps=400000, visualize=False, verbose=2, nb_max_episode_steps=10000,
            forward_other_agents=True)

    dqn.save_weights('shortchasetimewithhalt14act9pass3800000020000.h5f', overwrite=True)
