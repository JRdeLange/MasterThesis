...
### todo: predator laten wachten na eten, heading = 0,0,0
# researchers berichten
...
if __name__ == '__main__':
    ...
    dqn.load_weights('14act19pass50000010000.h5f')
    ...
    #input("waiter")
    environment.print_info = False

    dqn.test(environment, nb_episodes=5, visualize=True, nb_max_episode_steps=10000, forward_other_agents=True)
